<?php
function vgwc_body_default($post_id)
{
	...
	/* HTML Block */
	$vgwc_html .= '<div id="vgwc-wrapper'.$post_id.'" class="vgwc-wrapper theme-default owl-carousel '.$vgwc_class_sufix.'">';
		if($vgwc_total_items)
		{
