...
global $post, $projects_loop, $greek_options, $greek_projectrows, $greek_projectsfound;
...
$projects_loop['columns'] = $greek_options['portfolio_columns'];
...
<?php if ((0 == $projects_loop['loop'] % 2 || $greek_projectsfound == $projects_loop['loop']) && ($projects_loop['columns'] == 2)) { /* for odd case: $greek_projectsfound == $projects_loop['loop'] */
	if($greek_projectrows!=1) {
		echo '</div>';
	}
} ?>