				...
				<div class="page-content blog-page single <?php echo esc_attr($blogclass); if($blogsidebar=='left') {echo ' left-sidebar'; } if($blogsidebar=='right') {echo ' right-sidebar'; } ?>">
					<?php while (have_posts()) : the_post(); ?>
								...
								<div class="post-thumbnail">
									<div class="entry-attachment">
										<div class="attachment">
											 ...
											 * }
											 */
											$attachment_size = apply_filters('greek_attachment_size', array(960, 960));
								...
								<div class="post-info">
									...
									<footer class="entry-meta">
										<?php
											...
											printf(wp_kses(__('<span class="meta-prep meta-prep-entry-date">Published </span> <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>.', 'greek'), array('a' => array('href' => array(),'title' => array(), 'rel' => array()), 'span' => array('class' => array()), 'time' => array('class' => array(), 'datetime' => array()))),
						...
						<!--<nav id="image-navigation" class="navigation nav-single" role="navigation">
							<span class="previous-image nav-previous"><?php previous_image_link(false, esc_html__('&larr; Previous', 'greek')); ?></span>
							<span class="next-image nav-next"><?php next_image_link(false, esc_html__('Next &rarr;', 'greek')); ?></span>
