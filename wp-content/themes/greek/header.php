			...
			<div class="header">
				<div class="container">
					<div class="row">
						...
						<?php } ?>
						<div class="col-lg-4 col-md-4 col-sm-4 sp-logo">
						<?php if(!empty($greek_options['logo_main']['url'])){ ?>
							<div class="logo"><a href="<?php echo esc_url(home_url('/')); ?>" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="home"><img src="<?php echo esc_url($greek_options['logo_main']['url']); ?>" alt="" /></a></div>
						<?php
						} else { ?>
